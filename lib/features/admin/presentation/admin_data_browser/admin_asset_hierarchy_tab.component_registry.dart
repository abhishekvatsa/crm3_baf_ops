                ...
                if (constraints.maxWidth < 560)
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (_) => [
                      ...
                      if (!asset.isActive || asset.activeComponentCount == 0)
                        PopupMenuItem(
                          value: 'toggle',
                          child: ListTile(
                            leading: Icon(
                  ...
                  IconButton(
                    tooltip: asset.isActive
                        ? 'Retire physical asset'
                        : 'Restore physical asset',
                    onPressed:
                        busy ||
                            (asset.isActive && asset.activeComponentCount > 0)
                        ? null
                        : onToggleAsset,
                    icon: Icon(
                      asset.isActive
          ...
          child: componentsAsync.when(
            ...
            data: (components) => components.isEmpty
                ? const _EmptyHierarchy(
                    ...
                    message: 'Bind physical devices to this class definition.',
                  )
                : ListView.separated(
                    padding: const EdgeInsets.all(12),
                                ...
                                children: [
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      _StatusPill(active: component.isActive),
                                    ],
                                  ),
                                  Text(
                              ...
                              itemBuilder: (_) =>
                                  <PopupMenuEntry<_ComponentAction>>[
                                    ...
                                    if (component.isActive ||
                                      ...
                                      PopupMenuItem(
                                        value: _ComponentAction.toggleStatus,
                                        child: ListTile(
                                          leading: Icon(
                                            component.isActive
                                                ? Icons.archive_outlined
              ...
              child: components.when(
                ...
                data: (componentRecords) {
                  ...
                  return audits.when(
                    ...
                    error: (error, _) => _LoadFailure(
                      message: 'Lifecycle history could not be loaded: $error',
                          ...
                          .where(
                            (record) =>
                                ...
                                (record.relatedEntityId != null &&
                                    memberIds.contains(record.relatedEntityId)),
                          )
                          .toList();
                      if (history.isEmpty) {
...
String _componentAuditSubtitle(
  ...
  final evidenceLine = evidenceType == null
      ? null
