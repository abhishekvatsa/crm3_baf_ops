...
extension WorkflowAggregateRecordByIndex
  ...
  List<Id> putAllByFirestoreIdSync(
    List<WorkflowAggregateRecord> objects, {
    bool saveLinks = true,
  }) {
...
extension WorkflowAggregateRecordQueryWhere
    on
        QueryBuilder<
...
extension WorkflowAggregateRecordQueryFilter
    on
        QueryBuilder<
          WorkflowAggregateRecord,
          WorkflowAggregateRecord,
  ...
  >
  activeRedWorkEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'activeRedWork', value: value),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  awaitingPreparationEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'awaitingPreparation', value: value),
      );
    });
  }
  ...
  cancelledEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'cancelled', value: value),
      );
    });
  }
...
extension WorkflowAggregateRecordQueryObject
    on
        QueryBuilder<
          WorkflowAggregateRecord,
          WorkflowAggregateRecord,
...
extension WorkflowAggregateRecordQueryLinks
    on
        QueryBuilder<
          WorkflowAggregateRecord,
          WorkflowAggregateRecord,
...
extension WorkflowAggregateRecordQuerySortThenBy
    on
        QueryBuilder<
          WorkflowAggregateRecord,
          WorkflowAggregateRecord,
...
extension WorkflowAggregateRecordQueryWhereDistinct
    on
        QueryBuilder<
          WorkflowAggregateRecord,
          WorkflowAggregateRecord,
...
extension WorkflowAggregateRecordQueryProperty
    on
        QueryBuilder<
          WorkflowAggregateRecord,
          WorkflowAggregateRecord,
