...
`brace-expansion` 5.0.9 contains the upstream denial-of-service fix but changes
...
5.0.9 package while exposing both interfaces:

- CommonJS callers receive a callable function with the 5.0.9 named exports.
- ESM callers receive the 5.0.9 default and named exports.
