...
void main() {
  ...
  test('authority-negative collector is byte-bound and restoration-gated', () {
    ...
    for (final required in <String>[
      ...
      'Get-UiMarkers',
      'Move-ToMore',
      r'[DateTimeOffset]::UtcNow.AddSeconds($TimeoutSeconds)',
      r'while ([DateTimeOffset]::UtcNow -lt $deadline)',
      'Approved application navigation did not become visible within the bounded window.',
