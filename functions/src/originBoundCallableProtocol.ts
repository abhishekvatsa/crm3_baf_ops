...
const CONTRACTS = Object.freeze({
  mutateChargeAbnormalityV2: Object.freeze({
    payloadKey: "request",
    capabilityRevision: "chargeAbnormality.v2.20260912",
    capabilities: Object.freeze(["chargeAbnormality.v2", "qualityMonitoring.v1"]),
  }),
  assignPublishedTemplateVersionV2: Object.freeze({
    payloadKey: "request",
    capabilityRevision: "publishedTemplateAssignment.v2.20260912",
    capabilities: Object.freeze(["publishedTemplateAssignment.v2"]),
  }),
  mutateAssetHierarchyV2: Object.freeze({
    payloadKey: "request",
    capabilityRevision: "assetHierarchy.v2.20260912",
    capabilities: Object.freeze(["assetHierarchy.v2", "innerCoverAcceptance.v1"]),
  }),
  executeMaintenanceWorkflowCommandV2: Object.freeze({
    payloadKey: "command",
    capabilityRevision: "maintenanceWorkflow.v2.20260912",
...
export async function executeOriginBoundCallable<T>(args: {
  ...
  const requiredKeys = ["protocolVersion", "originActorUid", probe ? "probe" : contract.payloadKey].sort();
