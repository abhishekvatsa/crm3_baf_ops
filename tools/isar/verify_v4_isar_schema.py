...
def verify_migration() -> None:
    ...
    if 'currentSchemaVersion = 7' not in text: fail('Isar schema version is not v7')
...
def main() -> int:
    ...
    print(f"PASS: v7 Isar schema structure and P-06 provenance verified; provisional_bindings={len(marked)}; release_authority={'NO' if marked else 'YES'}")
    return 0
