...
def main()->int:
    ...
    add(c,'Isar migration version explicitly advances to v7',
        'currentSchemaVersion = 7' in migration and '3: _reconcileV4WorkflowPersistence' in migration
        ...
        and 'ReopenEvidence' in migration
